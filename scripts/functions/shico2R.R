...
#' its results to R for further usage. The resuls consist, for each time period,
#' of the seed words used and the produced time-dependent vocabulary. The 
...
# shico search terms for revolutionary politics  -------------------------------
...
shico_path_revo <- "shico_liberal_politics.csv"

# Load and preprocess shico data
preprocessed_shico_revo <- load_and_preprocess_shico(shico_path_revo)

# Save preprocessed shico data as csv file for later use
write.csv(preprocessed_shico_revo, "revolutionary_shico_vocabulary_per_year.csv", row.names = FALSE)
...
shico_path_replu <- "shico_republican_politics.csv"

# Load and preprocess shico data
preprocessed_shico_replu <- load_and_preprocess_shico(shico_path_replu)

# Save preprocessed shico data as csv for later use
write.csv(preprocessed_shico_replu, "republican_shico_vocabulary_per_year.csv", row.names = FALSE)
